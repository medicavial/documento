...
app.factory("qualitas", function($q,$http,find,api,publicfiles){
    return{
        ...
        actualizaFE:function(envio,datos){
            // console.log(datos);
            return $http.post(api+'qualitas/actualiza/'+ envio, datos);
        },
        ...
        descargaEnvioFE:function(archivo){
