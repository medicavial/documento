(function(){
    ...
    /** Sergio Alcala (2017)
    *Controlador de Factruacion Express Tradicional
    *Listo para colocar todo lo que venga de propias en AXA y Qualitas
    *
    */
    ...
    angular.module('app')
    .controller('facturacionExCtrl',facturacionExCtrl)
