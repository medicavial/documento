(function(){
    ...
    /** Sergio Alcala (2017)
    *Configuracion del Proyecto manjeo de rutas y excepciones. 
    */
    ...
    config.$inject = ['$routeProvider', 'IdleProvider', 'KeepaliveProvider', '$sceDelegateProvider', '$locationProvider'];

    //configuramos las rutas y asignamos html y controlador segun la ruta
    function config($routeProvider, IdleProvider, KeepaliveProvider, $sceDelegateProvider, $locationProvider){
