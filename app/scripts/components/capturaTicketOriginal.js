/**
*  Captura de Ticket y Registro de Original
*
*  Se realizo este sistema para capturar el regstro de original de un folio y un ticket 
*  en un solo paso
*
*  Sergio Alcala 05/12/2016
*/
...
(function(){
	...
	angular
	.module('app')
	.component('capturaTodo',{
		templateUrl:'vistas/capturaTodo.html',
		controller: capturaTicketOriginalCtrl,
		controllerAs:'cto'
	});

	capturaTicketOriginalCtrl.$inject = ['$scope', '$rootScope', '$filter', '$location', '$http', 'find', 'loading', 'checkFolios','carga','api', 'tickets'];;

	function capturaTicketOriginalCtrl($scope, $rootScope, $filter, $location, $http, find, loading, checkFolios, carga, api, tickets) {
