(function(){
	...
	angular
	.module('app')
	.component('capturaOriginal',{
		templateUrl:'vistas/capturaOriginal.html',
		controller: capturaOriginalCtrl,
		controllerAs:'ct'
	});

	capturaOriginalCtrl.$inject = ['$scope', '$rootScope', '$filter', '$location', '$http', 'find', 'loading', 'checkFolios','carga','api'];;

	function capturaOriginalCtrl($scope, $rootScope, $filter, $location, $http, find, loading, checkFolios, carga, api) {
