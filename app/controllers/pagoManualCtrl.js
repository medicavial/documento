function pagoManualCtrl($scope, $rootScope, loading,$filter,$location,$http,checkFolios,api, find, $upload, leexml, PagoManual, FacturaNormal){
    ...
    $scope.inicio = function(){
        ...
        $rootScope.area = 6;
        $scope.tituloPM = "Orden Pago Manual";
        $scope.listadoPre();
        $scope.tipoTramite();
        $scope.buscaProveedores();
        $scope.archivos = [];
...
///////////////////
//////////////////        VERIFICAMOS QUE LA UNIDAD NO SE ENCUENTRE EN LA LISTA DE CONDONADOS
//////////////////                
                        ...
                        if ($scope.PagoM.rfcemisor == courses.comprobante.emisor._rfc){
                            ...
                            if((courses.comprobante._fecha >= '2018-01-01') && (courses.comprobante._version != '3.3')){
                                ...
                                if (courses.comprobante.impuestos == undefined) {
                                    ...
                                    $scope.PagoM.isr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    $scope.PagoM.importeisr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    }
...
//////////////////////////////
/////////////////////////////        VERIFICAMOS QUE EL FOLIO FISCAL NO ESTE REPETIDO
////////////////////////////
...
////////////////
////////////////              VERIFICAMOS A PROVEEDOR O UNIDAD QUE ESTAN CONDONADOS 
////////////////
...
//////////////////////////////
/////////////////////////////      VERIFICAMOS LA UNIDAD  SI COINCIDE CON FACTURA A PAGAR
/////////////////////////////
                        ...
                        if ($scope.PagoI.rfcemisor == courses.comprobante.emisor._rfc){
                            ...
                            if((courses.comprobante._fecha >= '2018-01-01') && (courses.comprobante._version != '3.3')){
                                ...
                                if (courses.comprobante.impuestos == undefined) {
                                    ...
                                    $scope.PagoI.isr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    $scope.PagoI.importeisr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    }
                            ...
                            if((courses.comprobante._fecha >= '2018-01-01') && (courses.comprobante._version != '3.3')){
                                ...
                                if (courses.comprobante.impuestos == undefined) {
                                    ...
                                    $scope.PagoI.importeisr = '';
                                        ...
                                        console.log(courses.comprobante.impuestos._totalimpuestosretenidos);
                        ...
                        if ($scope.PagoI.rfcemisor == courses.comprobante.emisor._rfc){
                            ...
                            if((courses.comprobante._fecha >= '2018-01-01') && (courses.comprobante._version != '3.3')){
                                ...
                                if (courses.comprobante.impuestos.retenciones == undefined) {
                                    ...
                                    $scope.NCI.isr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    $scope.NCI.importeisr = courses.comprobante.impuestos._totalimpuestosretenidos;
                        ...
                        if ($scope.PagoM.rfcemisor == courses.comprobante.emisor._rfc){
                            ...
                            if((courses.comprobante._fecha >= '2018-01-01') && (courses.comprobante._version != '3.3')){
                                ...
                                if (courses.comprobante.impuestos.retenciones == undefined) {
                                    ...
                                    $scope.NCG.isr = courses.comprobante.impuestos._totalimpuestosretenidos;
                                    $scope.NCG.importeisr = courses.comprobante.impuestos._totalimpuestosretenidos;
...
pagoManualCtrl.$inject = ['$scope', '$rootScope',  'loading','$filter','$location','$http','checkFolios','api','find', '$upload', 'leexml', 'PagoManual', 'FacturaNormal'];
