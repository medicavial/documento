...
function controladorOriginal($scope, $rootScope, $filter, $location, $http, find, loading, checkFolios, carga, api, RegistroZimaMV,webStorage) {
        ...
        if(folio==''){
            ...
            find.folioZima($scope.folioZima).success( function (data) {  
                ...
                if(data.length>0){
                    ...
                    if(data[0].UNI_clave==118||data[0].UNI_clave==181||data[0].UNI_clave==2183||data[0].UNI_clave==2250||data[0].UNI_clave==2289||data[0].UNI_clave==2250||data[0].UNI_clave==151||data[0].UNI_clave==2182||data[0].UNI_clave==2166){
    ...
    $scope.referencia = function(unidad){
        ...
        if(unidad==28||unidad==278||unidad==243||unidad==247||unidad==1356||unidad==352||unidad==357||unidad==110||unidad==364||unidad==128){
